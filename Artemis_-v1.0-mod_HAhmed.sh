...
if [ -d /usr/share/enigma2/Artemis_mod_HA ]; then
echo "> removing package please wait..."
sleep 3s 
rm -rf /usr/share/enigma2/Artemis_mod_HA >/dev/null 2>&1
...
#config
skin=Skin-Artemis_-v1.0-mod-HAhmed
version=1.0
url=https://raw.githubusercontent.com/Ham-ahmed/288/refs/heads/main/Artemis_-v1.0-mod_HA.tar.gz
